    ...
    <div class="header-container__top " :class="this.$route.name === 'apartment-page' ? 'border-transparent' : ''">
      <div class="d-flex justify-content-between align-items-center py-3" :class="this.$route.name !== 'apartment-page' ? 'ms-page-container' : 'ms-page-container-small'">
        ...
        <div class="h-top-right d-flex justify-content-end align-items-center w-25">
          <a class="rent rounded-pill py-2 px-3 ms-3 fw-semibold text-decoration-none text-dark d-none d-lg-inline" href="" @click.native="this.$router.push({ name: 'advance-search', params: { address: 'Italia'}})">Affitta con BoolBnB</a>
          ...
          <div class="btn-group rounded-pill ms-3">
            ...
            <ul class="dropdown-menu dropdown-menu-end mt-2">
              ...
              <li><a href="" @click.native="this.$router.push({ name: 'advance-search', params: { address: 'Italia'}})" class="dropdown-item d-block d-lg-none">Affitta con BoolBnB</a></li>
            </ul>
          </div>
        </div>
      </div>
