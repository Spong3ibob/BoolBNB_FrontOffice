...
export default {
  ...
  methods: {
    publicFunction() {
      axios
        .post(
          `${this.store.backendUrl}/message/create/email=${this.email}&content=${this.message}&apartmentId=${this.info.id}`
        )
        .then((response) => {
...
<template>
  <div class="container-card line-space-divider ms-auto">
    <div class="card">
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li>
                ...
                <input type="number" name="adulti" placeholder="1" />
              </li>
              <li>
                <label for="bambini">Bambini</label>
                <input type="number" name="bambini" placeholder="0" />
              </li>
              <li>
                <label for="neonati">Neonati</label>
                <input type="number" name="neonati" placeholder="0" />
              </li>
              <li>
      ...
      <button type="button" id="prenota-button" class="my-btn mb-3">
        Prenota
      </button>
      ...
      <div
        ...
        id="boxMessager"
        tabindex="-1"
        aria-labelledby="boxMessagerLabel"
        aria-hidden="true"
      >
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="host-button">
                <strong>Contatta l'host {{ info.user.name }}</strong>
              </h1>
              <button
                type="button"
                class="my-btn"
  ...
  <div
    class="alert alert-success alert-dismissible fade show mt-3 container-card ms-auto mt-4"
    role="alert"
    v-if="this.is_sent"
  >
